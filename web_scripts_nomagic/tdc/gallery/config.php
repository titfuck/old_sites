 ...
 */
$gallery->setConfig('setup.password', 'm8nk8yB8by');
 ...
 */
$gallery->setConfig('data.gallery.base', '/afs/athena.mit.edu/activity/t/tdc/scripts-gallery2/tdc+gallery1/');
...
$storeConfig['hostname'] = 'sql.mit.edu';
$storeConfig['database'] = 'tdc+gallery1';
$storeConfig['username'] = 'tdc';
$storeConfig['password'] = 'tdsequel';
$storeConfig['schema'] = '';
 ...
 */
$gallery->setConfig('baseUri', 'http://tdc.scripts.mit.edu/tdc/gallery/main.php');
?>
