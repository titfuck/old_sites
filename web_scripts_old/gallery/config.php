 ...
 */
$gallery->setConfig('setup.password', 'tdsizzle');
 ...
 */
$gallery->setConfig('data.gallery.base', '/mit/tdc/scripts-gallery2/tdc+gallery');
...
$storeConfig['database'] = 'tdc+gallery';
$storeConfig['username'] = 'tdc';
$storeConfig['password'] = '441660c';
