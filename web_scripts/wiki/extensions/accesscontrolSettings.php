<?php
	$wgAccessControlDisableMessages = true;			// if set to false, show a line on top of each secured page, which says, which groups are allowed to see this page.
	$wgWikiVersion = 1.9;						// Set this to 1.6 or higher, if you use mediaWiki 1.6.X, this is for compatibility reasons
	$wgAdminCanReadAll = false;					// sysop users can read all restricted pages
	$wgUseMediaWikiGroups = true;					// use the groups from MediaWiki instead of own Usergroup pages
	...
	$wgAccessControlNoAccessPage = "/wiki/Main_Page";	 			// To this page will these users redirected who ar not allowed to see the page.
