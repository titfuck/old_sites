...
var options={backgroundColor:this.p_backgroundColor(),scaleMode:this.p_scaleMode(),movieMode:this.p_movieMode(),shouldTighten:false};this.mSlideshow=new Slideshow(slideshowDiv,photos,function(){},options);var transitionIndex=this.p_transitionIndex();var scrub=transitionIndex==255;if(scrub)
...
{photos[index].image.load(loadImage);}}}.bind(this);loadImage();}
...
{var slideshowDiv=this.getElementById("slideshow_placeholder");var left=0;var totalWidth=slideshowDiv.offsetWidth;var bands=slideshowDiv.getElementsByClassName("scrubBand");for(var i=0;i<bands.length;++i)
