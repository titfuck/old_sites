...
{var commentCountText=this.commentCountText(count,enabled);var spans=document.getElementsByClassName("bl-value-comment-count",itemNode);spans.forEach(function(node)
...
{var localizedSpans=document.getElementsByClassName("bl-localized",parent);localizedSpans.each(function(span)
...
{var cropDivs=document.getElementsByClassName("crop",div);var cropDiv=cropDivs[cropDivs.length-1];if(cropDiv)
